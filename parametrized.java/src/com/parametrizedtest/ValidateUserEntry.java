...
public class ValidateUserEntry {
	public boolean firstName(String inputStr1) {
		...
		java.util.regex.Matcher firstNameMatcher = regex.matcher(inputStr1);
	...
	public boolean lastName(String inputStr2) {
		...
		Pattern regex = Pattern.compile(namePattern);
		;
		java.util.regex.Matcher firstNameMatcher = regex.matcher(inputStr2);
		if (firstNameMatcher.matches()) {
	...
	public boolean contactNumber(String inputStr3) {
		...
		java.util.regex.Matcher contactNumMatcher = regex.matcher(inputStr3);
	...
	public boolean emailID(String inputStr4) {
		...
		java.util.regex.Matcher emailIDMatcher = regex.matcher(inputStr4);
